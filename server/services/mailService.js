...
const sendSignUpEmail = async (userEmail, userName) => {
  const htmlContent = `
    ...
    <html>
      ...
      <body>
        <div class="container">
          <div class="header">
            <h1>Welcome to Hit Republic! 🎉</h1>
          </div>
          <div class="content">
            <h2>Hello ${userName},</h2>
            <p>Thank you for signing up for Hit Republic! We're excited to have you on board.</p>
          ...
          <div class="footer">
            <p>&copy; 2025 Hit Republic. All rights reserved.</p>
          </div>
        </div>
      </body>
    </html>
  ...
  try {
    const data = await resend.emails.send({
      from: FROM_EMAIL,
      to: userEmail,
      subject: 'Welcome to Hit Republic!',
      html: htmlContent,
    });
...
const sendSuspensionEmail = async (userEmail, userName, reason) => {
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hello ${userName},</h2>
            <p>We regret to inform you that your Hit Republic account has been suspended.</p>
            <div class="warning-box">
              <h3>Suspension Reason:</h3>
              <p>${reason}</p>
            </div>
            <p>If you believe this suspension is a mistake, please contact our support team immediately at support@hitrepublic.com</p>
  ...
  try {
    const data = await resend.emails.send({
      from: FROM_EMAIL,
      to: userEmail,
      subject: 'Your Hit Republic Account Has Been Suspended',
      html: htmlContent,
    });
...
const sendUnsuspensionEmail = async (userEmail, userName) => {
    ...
    <html>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            <h2>Hello ${userName},</h2>
            <p>Great news! Your Hit Republic account has been unsuspended and is now active again.</p>
            ...
            <p style="margin-top: 30px; border-top: 1px solid #ddd; padding-top: 20px;">If you have any questions, please don't hesitate to contact our support team at support@hitrepublic.com</p>
          </div>
          <div class="footer">
            <p>&copy; 2025 Hit Republic. All rights reserved.</p>
          </div>
  ...
  try {
    const data = await resend.emails.send({
      from: FROM_EMAIL,
      to: userEmail,
      subject: 'Your Hit Republic Account Has Been Restored',
      html: htmlContent,
    });
